...
const BroadcastScreen = () => {
    ...
    return <View
        className="w-full h-full flex relative bg-fill-background items-center justify-center p-9"
    >
        <View className="w-full flex flex-col space-y-6 items-stretch">
            <SubtitledText
                align='center'
                text={isBroadcasting ? "we're live!" : 'all quiet.'}
                subtitle={isBroadcasting ? "sharing your profile with nearby people." : "people can't see you right now." }
            />
